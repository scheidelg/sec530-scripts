...
# every time this script is run, (b) executed only once, or (c) executed only
# when specifically requested.
#
# In the case of commands that are executed only once, a unique tag (a string
# of text) is used to identify a set of commands.  Before a set of commands is
...
# on the command line.  Command-line arguments to wiki_update.ps1 are passed
# when calling this stage2.ps1 script
